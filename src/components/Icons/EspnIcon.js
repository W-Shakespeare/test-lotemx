export const EspnIcon = ({ height = 250, width = 250 }) => {
  return (
    <div className="epsnIcon">
      <svg
        version="1.1"
        id="logosvg.com"
      ...
      >
        <path
          id="red"
          class="st0"
          d="M132.8,102.3c-14.4,0-23.9,7.6-25.3,18.9c-0.3,2.6-0.6,5.2-1,7.9h187.3c0,0,0.4-2.8,0.6-5
